...
local tree = htmlparser.parse(path'systems.xml':read())
...
path'openExoplanetCatalog.json':write(json.encode(results, {indent=true}))
--]]
-- [[
path'openExoplanetCatalog.lua':write(tolua(resultSystems))
--]]
